...
class m140703_123000_user extends Migration
{
    ...
    public function safeUp()
    {
        ...
        $this->createTable('{{%base_user_profile}}', [
        ...
        $this->addForeignKey('fk_user', '{{%base_user_profile}}', 'user_id', '{{%base_user}}', 'id', 'cascade', 'cascade');
    ...
    {
        $this->dropForeignKey('fk_user', '{{%base_user_profile}}');
        $this->dropTable('{{%base_user_profile}}');
